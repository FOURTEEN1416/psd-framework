...
> Owner: `docs/paper/experiment-skeleton.md` · W5 窗口 2026-08-23 · 状态: 骨架 v0.6——E1-E4 数字在档；**E5 负结果如实入册且 C7 经用户裁决①降级"探索性发现"（2026-08-25）**；E6 回填 C1 合成层 small 档真证据（full 档待 GPU 确认）；tab3 六行中四行已映射、两行 PENDING
...
- fig4 引用保留：负结果效率曲线照画（W22 绘制中），落点随降级从 §4.3 迁至 §5 分析节。
