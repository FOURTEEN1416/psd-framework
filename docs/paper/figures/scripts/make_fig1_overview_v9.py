...
ax.text(24, 79.8, r"Physics layer $\Phi$ (frozen)", ha="center",
        fontsize=7.0, fontweight="bold", color=psd_style.PHYS_TEXT, zorder=6)
...
ax.text(86, 79.8, r"Semantic layer $\Omega$ (revisable)", ha="center",
        fontsize=7.0, fontweight="bold", color=C_SEM_EDGE, zorder=6)
...
arrow(33.5, 58.0, 33.5, 71.0); arrow(33.5, 71.0, 52.5, 71.0)
...
arrow(84, 8.0, 86.2, 16.9, color=C_SEM_EDGE, lw=1.25, ls=(0, (3, 2)))
