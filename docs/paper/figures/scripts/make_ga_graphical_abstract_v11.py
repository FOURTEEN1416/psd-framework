# -*- coding: utf-8 -*-
"""graphical abstract v11 — Elsevier GA 规格（R30 海洋清风编辑级：无阴影扁平+
细流线；条图承 v9/v10。NTU120 浅青条文字改墨色保对比）。

规格: ≤531×131 pt ≈ 7.375×1.82 in,印刷尺寸 1:1 铁律(figsize 直接落)，
  PNG 600dpi + PDF 矢量。三元素——① 双柔色块(深青系=物理冻结 Φ / 深橙系=语义可修订 Ω)
  ② Y→Y′ 演化虚流线只穿语义层 ③ 右侧保留率微条(NTU60 青绿 90.7 墨字 /
  NTU120 浅青 88.9 墨字 / canine 28.9 橙描边斜纹+条外橙字)。
...
rows = [
    ...
    ("NTU120", 88.9, False, psd_style.S_NTU120, psd_style.INK),  # R30: 浅青条墨字(白字对比不足)
...
print("GA v11 (R30 ocean editorial) saved"); print("print size: 7.375 x 1.82 in (= 531 x 131 pt, Elsevier GA limit)")
