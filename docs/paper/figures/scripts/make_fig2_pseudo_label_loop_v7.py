...
def seg(a, b, label=None, lp=0.5, ldy=2.2, curve=0.0, ls="solid", lw=1.15, color=SOFT,
    ...
    if label:
        ...
        ax.text(mx, my, label, fontsize=5.8, color="#4B5563", ha="center", va="center", zorder=5)
...
ax.text(49.25, 84.0, "next round", fontsize=5.8, color="#4B5563", ha="center", va="center")

# ---- 下排人工分支 ----
seg("assign", "al")
ax.text(13.2, 53.0, r"$\kappa < \tau$", fontsize=5.8, color="#4B5563", ha="left", va="center")
seg("al", "verified")
