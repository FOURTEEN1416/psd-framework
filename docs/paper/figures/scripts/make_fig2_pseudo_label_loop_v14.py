# -*- coding: utf-8 -*-
r"""fig2 v14 — 伪标签循环双行管线（R41 紧凑版：修 V1 底部留白——画布收紧+行距压缩；拓扑承 v13）。automated=深橙系，human=青绿系，hub=墨黑。"""
import matplotlib
matplotlib.use("Agg")
import numpy as np
...
ax.set_xlim(0, 100); ax.set_ylim(21.5, 86)
ax.axis("off")
...
print("fig2 v14 (R41 compact layout: V1 whitespace fixed) saved")
