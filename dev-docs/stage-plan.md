...
> 状态: 🔄 执行中——P0.1 ✅ / P0.2 ✅ 救援+冲刺达标（W7，E-C 定稿收尾中）/ P0.3 PhaseA ✅（W8）/ **P0.4 ✅ 完成并经复核确认（W10）** / P0.5 前置工程 ✅ W11 完成 / P0.5 骨干微调评估 ✅ W12 已排程 / P0.6 写作侧 ✅ 清空待回填；详见 HANDOVER v1.7 §8
...
| P0.5 骨干微调评估 | 1 周 | ST-GCN+BC / Mamba 微调 ≥85%（22 类） | 三层指标口径报告（**前置工程 W11 完成：assets-map 补链 + 合成数据 22 类重建（440 样本/3.80 MB）+ ST-GCN+BC 进仓 + 冒烟 val_acc=18.2%≥10% 全通过；完整训练 + E6 双贴合实验 W12 已排程**） |
