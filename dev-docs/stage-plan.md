...
> 状态: 🔄 执行中——P0.1 ✅ / P0.2 ✅ 救援+冲刺达标（W7，E-C 定稿收尾中）/ P0.3 PhaseA ✅（W8）/ **P0.4 ✅ 完成并经复核确认（W10）** / P0.5 前置工程 ✅ W11 完成（assets-map 补链 + 合成22类骨架集 + ST-GCN+BC 进仓 + 冒烟训练 18.2%≥10%）/ P0.6 写作侧 ✅ 清空待回填；详见 HANDOVER v1.6 §8
...
| P0.5 骨干微调评估 | 1 周 | ST-GCN+BC / Mamba 微调 ≥85%（22 类） | 三层指标口径报告（**前置工程 W11 完成：assets-map 补链 + 合成数据 22 类重建（440 样本/3.80 MB）+ ST-GCN+BC 进仓 + 冒烟 val_acc=18.2%≥10% 全通过；微调达标实验待 W12 开窗**） |
