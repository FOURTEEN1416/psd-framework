...
| 08-24 23:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 100 %, 7692 MiB | 无条件变化, 不干预 |
| 08-25 00:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 99 %, 7653 MiB | 无条件变化, 不干预 |
| 08-25 00:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7662 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 00:42 | 发现陌生训练进程占卡(§6.1)——不杀不动, 上报待裁决, 本轮暂停接力 | 100 %, 7743 MiB | PID=38344:"C:\Program Files\Python312\python.exe" scripts\run_p05_al_warmstart.py --config |
| 08-25 00:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7664 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 01:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 96 %, 7618 MiB | 无条件变化, 不干预 |
| 08-25 01:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 35 %, 7600 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 01:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 99 %, 7629 MiB | 无条件变化, 不干预 |
| 08-25 01:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7635 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 02:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 98 %, 7649 MiB | 无条件变化, 不干预 |
| 08-25 02:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 25 %, 7630 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 02:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 98 %, 7628 MiB | 无条件变化, 不干预 |
| 08-25 02:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 26 %, 7633 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 03:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 100 %, 7652 MiB | 无条件变化, 不干预 |
| 08-25 03:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7658 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 03:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 96 %, 7683 MiB | 无条件变化, 不干预 |
| 08-25 03:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 1 %, 7689 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 04:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 100 %, 7638 MiB | 无条件变化, 不干预 |
| 08-25 04:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 73 %, 7643 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 04:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 99 %, 7651 MiB | 无条件变化, 不干预 |
| 08-25 04:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7657 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 05:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 72 %, 7643 MiB | 无条件变化, 不干预 |
| 08-25 05:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7674 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 05:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 67 %, 7619 MiB | 无条件变化, 不干预 |
| 08-25 05:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7625 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 06:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 97 %, 7647 MiB | 无条件变化, 不干预 |
| 08-25 06:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 2 %, 7658 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 06:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 85 %, 7632 MiB | 无条件变化, 不干预 |
| 08-25 06:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 6 %, 7640 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 07:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 99 %, 7657 MiB | 无条件变化, 不干预 |
| 08-25 07:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 2 %, 7650 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 07:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 100 %, 7659 MiB | 无条件变化, 不干预 |
| 08-25 07:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7660 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 08:12 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 96 %, 7631 MiB | 无条件变化, 不干预 |
| 08-25 08:12 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 98 %, 7662 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
| 08-25 08:42 | 例行巡检: NTU 占用中(ntu_proc=2), 继续等待 | 18 %, 7620 MiB | 无条件变化, 不干预 |
| 08-25 08:42 | 检测到 W19/C1 相关新提交——Q2 前置(TDD 全绿)需人工核验 | 100 %, 7644 MiB | 不自动启动 Q2, 待协调者/用户裁决 |
